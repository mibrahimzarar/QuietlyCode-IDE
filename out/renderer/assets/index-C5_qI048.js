const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./xterm-EsaqrrTX.css"])))=>i.map(i=>d[i]);
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "OPEN_FILE": {
      const exists = state.openFiles.find((f2) => f2.path === action.file.path);
      if (exists) {
    ...
    case "CLOSE_FILE": {
      const files = state.openFiles.filter((f2) => f2.path !== action.path);
    ...
    case "UPDATE_FILE_CONTENT":
      return {
        ...
        openFiles: state.openFiles.map(
          (f2) => f2.path === action.path ? { ...f2, content: action.content, isDirty: true } : f2
        )
      };
    case "MARK_FILE_SAVED":
      return {
        ...state,
        openFiles: state.openFiles.map(
          (f2) => f2.path === action.path ? { ...f2, isDirty: false } : f2
        )
      };
    case "SET_AI_STATUS":
...
function SetupScreen() {
  ...
  const [setupDownloadDir, setSetupDownloadDir] = reactExports.useState("");
  const [serverBinaryPath, setServerBinaryPath] = reactExports.useState("");
  const [localModels, setLocalModels] = reactExports.useState([]);
  const [downloading, setDownloading] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(0);
  const [speed, setSpeed] = reactExports.useState("");
  const [error, setError] = reactExports.useState("");
  const [binaryProgress, setBinaryProgress] = reactExports.useState(0);
  const [binaryStatus, setBinaryStatus] = reactExports.useState("");
  const [downloadingBinary, setDownloadingBinary] = reactExports.useState(false);
  ...
  function handleUseExistingModel(modelPath) {
    finishSetup(modelPath);
  }
  async function finishSetup(modelPath) {
    const settings = {
      modelPath,
      serverBinaryPath,
  ...
  const StepDots = ({ active }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-steps", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `ws-dot ${i < active ? "done" : ""} ${i === active ? "current" : ""}`, children: i < active ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12 }) : i }),
    i < 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `ws-line ${i < active ? "done" : ""}` })
  ] }, i)) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-bg-glow" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-card", children: [
      step === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-intro", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-intro-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { size: 56, strokeWidth: 1 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "ws-title", children: "BitNet IDE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ws-tagline", children: "Private · Local · Intelligent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ws-desc", children: "A calm, AI‑powered pair programmer running entirely on your machine. No API keys. No data leaks. Just code." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "ws-btn ws-btn-primary ws-btn-lg", onClick: () => setStep("paths"), children: [
          "Get Started ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18 })
        ] })
      ] }),
      step === "paths" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-body", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StepDots, { active: 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Environment Setup" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ws-subtitle", children: "Configure where BitNet stores models and binaries." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }),
            " Models Directory"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-input-row", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ws-btn ws-btn-secondary", onClick: handleSelectModelsDir, children: "Browse" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ws-help", children: "The engine that runs the models on your hardware." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-binary-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: `ws-btn ws-binary-btn ${serverBinaryPath ? "success" : ""}`,
                onClick: serverBinaryPath ? void 0 : handleDownloadBinary,
                disabled: downloadingBinary || !!serverBinaryPath,
                children: downloadingBinary ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ws-spinner" }),
                  binaryStatus || "Downloading…",
                  " ",
                  Math.round(binaryProgress),
                  "%"
                ] }) : serverBinaryPath ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            !serverBinaryPath && !downloadingBinary && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ws-btn ws-btn-ghost", onClick: handleSelectServerBinary, children: "Browse Local" })
          ] }),
          serverBinaryPath && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-path-chip", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12 }),
            " ",
            serverBinaryPath
          ] })
        ] }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-error", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertCircle, { size: 14 }),
          " ",
          error
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "ws-btn ws-btn-ghost", onClick: () => setStep("intro"), children: [
      ...
      step === "models" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-body", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StepDots, { active: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Choose a Model" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ws-subtitle", children: "Pick an AI model to power your coding assistant." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-models-scroll", children: [
          localModels.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "ws-group-label", children: "Installed" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-model-list", children: localModels.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                className: "ws-model-card",
                onClick: () => handleUseExistingModel(m2.path),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(HardDrive, { size: 22, className: "ws-model-icon installed" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-model-info", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: m2.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ready to use" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ws-model-size", children: m2.size })
                ]
              },
              i
            )) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "ws-group-label", children: "Available for Download" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-model-list", children: models.filter((m2) => !localModels.some((l2) => l2.name === m2.filename)).map((model) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              className: `ws-model-card ${selectedModel === model.id ? "active" : ""}`,
              onClick: () => setSelectedModel(model.id),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 22, className: "ws-model-icon" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-model-info", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: model.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: model.description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ws-model-size", children: model.size })
              ]
            },
            model.id
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "ws-btn ws-btn-ghost", onClick: () => setStep("paths"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 14 }),
            " Back"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      step === "download" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-body ws-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-download-visual", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ws-pulse-ring" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 36 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Downloading Model…" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-progress-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ws-progress-fill", style: { width: `${progress}%` } }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ws-progress-stats", children: [
...
function TitleBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-logo", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { size: 16, strokeWidth: 2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "BitNet IDE" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "titlebar-btn", onClick: toggleTheme, title: "Toggle Theme", children: state.settings.theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 14 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "titlebar-btn", onClick: () => dispatch({ type: "TOGGLE_SETTINGS" }), title: "Settings", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 14 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "titlebar-btn", onClick: () => window.electronAPI.minimize(), title: "Minimize", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 14 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "titlebar-btn", onClick: () => window.electronAPI.maximize(), title: "Maximize", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 12 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "titlebar-btn close", onClick: () => window.electronAPI.close(), title: "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14 }) })
    ] })
  ] });
}
function Sidebar() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("explorer");
  const [searchQuery, setSearchQuery] = reactExports.useState("");
  const [searchResults, setSearchResults] = reactExports.useState([]);
  const [isSearching, setIsSearching] = reactExports.useState(false);
  const [newItemMode, setNewItemMode] = reactExports.useState(null);
  const [newItemParent, setNewItemParent] = reactExports.useState(null);
  ...
  const [contextMenuPos, setContextMenuPos] = reactExports.useState(null);
  ...
  function startNewItem(type, parentPath) {
    setNewItemMode(type);
    setNewItemParent(parentPath);
    setNewItemName("");
    setExpandedDirs((prev) => /* @__PURE__ */ new Set([...prev, parentPath]));
  }
  async function createNewItem() {
    if (!newItemName || !newItemParent || !newItemMode) return;
    const path = `${newItemParent}\\${newItemName}`;
    const result = newItemMode === "file" ? await window.electronAPI.createFile(path) : await window.electronAPI.createFolder(path);
  ...
  function handleContextMenu(e, path, isDir) {
    e.preventDefault();
    e.stopPropagation();
  ...
  function renderTree(nodes, depth = 0) {
    return nodes.map((node) => {
      ...
      if (renamingPath === node.path) {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tree-item", style: { paddingLeft: `${14 + depth * 16}px` }, children: [
          node.isDirectory ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              node.isDirectory && (isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14 })),
              node.isDirectory ? isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FolderClosed, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: node.name })
            ]
          }
        ),
        node.isDirectory && isExpanded && newItemParent === node.path && newItemMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tree-item", style: { paddingLeft: `${14 + (depth + 1) * 16}px` }, children: [
          newItemMode === "folder" ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              className: "inline-rename",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar", onClick: () => setContextMenuPos(null), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Files, { size: 14 }),
            " Explorer"
          ]
        }
      ),
    ...
    activeTab === "explorer" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: state.projectPath ? state.projectPath.split("\\").pop() : "Explorer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "4px" }, children: [
          state.projectPath && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(FilePlus, { size: 14 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost btn-icon", onClick: handleOpenFolder, title: "Open Folder", style: { width: 24, height: 24 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-content", children: [
        state.projectPath && newItemParent === state.projectPath && newItemMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tree-item", style: { paddingLeft: "14px" }, children: [
          newItemMode === "folder" ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
        ...
        state.fileTree.length > 0 ? renderTree(state.fileTree) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-empty", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 32, strokeWidth: 1 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Open a folder to get started" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-primary", onClick: handleOpenFolder, children: "Open Folder" })
        ] })
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-results", children: [
        isSearching && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "20px", textAlign: "center", color: "var(--text-tertiary)", fontSize: "12px" }, children: "Searching..." }),
        !isSearching && searchResults.length === 0 && searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "20px", textAlign: "center", color: "var(--text-tertiary)", fontSize: "12px" }, children: "No results found" }),
        searchResults.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "search-result-item",
            onClick: () => openSearchResult(r2.file, r2.line),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 12, style: { flexShrink: 0 } }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minWidth: 0, overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "12px", fontWeight: 500, color: "var(--text-primary)" }, children: [
                  r2.file.split("\\").pop(),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "var(--text-tertiary)", marginLeft: "4px" }, children: [
                    ":",
                    r2.line
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "11px", color: "var(--text-secondary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: r2.content })
              ] })
            ]
          },
          i
    ...
    contextMenuPos && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          contextMenuPos.isDir && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "file-context-menu-item", onClick: () => {
              startNewItem("file", contextMenuPos.path);
              setContextMenuPos(null);
            }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilePlus, { size: 12 }),
              " New File"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "file-context-menu-item", onClick: () => {
              startNewItem("folder", contextMenuPos.path);
              setContextMenuPos(null);
            }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FolderPlus, { size: 12 }),
              " New Folder"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-context-menu-separator" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "file-context-menu-item", onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "file-context-menu-item danger", onClick: () => {
            handleDelete(contextMenuPos.path);
            setContextMenuPos(null);
          }, children: [
...
var Ft = de;
const PROMPTS = {
  explain: (code) => `Explain the following code concisely and clearly. Focus on what it does and why:

\`\`\`
${code}
\`\`\``,
  refactor: (code, instruction) => `Refactor the following code.${instruction ? ` ${instruction}` : ""} Keep changes minimal and preserve behavior. Return only the refactored code:

\`\`\`
${code}
\`\`\``,
  generate: (description) => `Generate code for the following requirement. Be concise and precise:

${description}`,
  edit: (code, instruction) => `Apply the following edit to the code below. Return only the modified code.
...
${code}
\`\`\``,
  analyzeProject: (summary) => `Analyze this project based on the following codebase summary. Provide a high-level overview of:
...
Codebase Summary:
${summary}`,
  system: `You are a precise, helpful AI coding assistant running locally via BitNet.cpp. You are embedded in an IDE. Follow these rules:
...
- Never suggest cloud services`,
  systemWithContext: (projectContext) => `You are a precise, helpful AI coding assistant running locally via BitNet.cpp. You are embedded in an IDE and have context about the current project.
...
function Editor() {
  ...
  const activeFile = state.openFiles.find((f2) => f2.path === state.activeFilePath);
  const handleMount = (editor, monaco) => {
    ...
    editor.addAction({
      ...
      run: () => {
        const sel = editor.getModel()?.getValueInRange(editor.getSelection()) || "";
        if (sel) {
          const instruction = prompt("Describe the edit:");
          if (instruction) {
            dispatch({
              type: "ADD_CHAT_MESSAGE",
              message: {
                id: Date.now().toString(),
                role: "user",
                content: PROMPTS.edit(sel, instruction),
                timestamp: Date.now()
              }
            });
            if (!state.chatPanelVisible) dispatch({ type: "TOGGLE_CHAT_PANEL" });
  ...
  const handleChange = reactExports.useCallback((value) => {
    if (value !== void 0 && activeFile) {
      dispatch({ type: "UPDATE_FILE_CONTENT", path: activeFile.path, content: value });
    }
  }, [activeFile?.path]);
  if (!activeFile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "editor-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "editor-placeholder", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Code2, { size: 48, strokeWidth: 1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Open a file to start editing" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "editor-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Ft,
    {
...
function TabBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-bar", children: state.openFiles.map((file) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `tab ${state.activeFilePath === file.path ? "active" : ""}`,
      onClick: () => dispatch({ type: "SET_ACTIVE_FILE", path: file.path }),
      children: [
        file.isDirty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tab-dirty" }),
...
function ChatPanel() {
  ...
  const streamContentRef = reactExports.useRef("");
  const [codebaseContext, setCodebaseContext] = reactExports.useState(null);
  ...
  async function sendToAI() {
    ...
    streamContentRef.current = "";
    const systemPrompt = codebaseContext ? PROMPTS.systemWithContext(codebaseContext) : PROMPTS.system;
    const messages = [
      { role: "system", content: systemPrompt },
      ...state.chatMessages.filter((m2) => m2.role !== "system").map((m2) => ({ role: m2.role, content: m2.content }))
    ];
  ...
  const [models, setModels] = reactExports.useState([]);
  const [switchingModel, setSwitchingModel] = reactExports.useState(false);
  const [currentModelName, setCurrentModelName] = reactExports.useState("Loading...");
  reactExports.useEffect(() => {
    loadModels();
  }, []);
  reactExports.useEffect(() => {
    if (state.settings.modelPath) {
      const name = state.settings.modelPath.split(/[\\/]/).pop();
      setCurrentModelName(name || "Unknown Model");
    } else {
      setCurrentModelName("Select Model");
    }
  ...
  async function handleModelSelect(modelPath) {
    if (modelPath === state.settings.modelPath) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", overflow: "hidden" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 16 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-selector-wrapper", style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, children: "Select Model" }),
                models.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: m2.path, children: m2.name }, m2.path))
              ]
            }
          ),
          switchingModel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "10px", marginLeft: "8px", opacity: 0.7 }, children: "Starting..." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-header-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "btn btn-ghost btn-icon",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "quick-actions", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          title: "Select code first",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Wand2, { size: 12 }),
            " Refactor"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "quick-action-btn", onClick: () => handleQuickAction("generate"), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          disabled: !state.projectPath || analyzing,
          title: state.projectPath ? "Analyze open project" : "Open a project first",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Scan, { size: 12 }),
            " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-messages", children: [
      state.chatMessages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        display: "flex",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 28, strokeWidth: 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "13px" }, children: "Ask me anything about your code, or select code and use the quick actions above." })
      ] }),
      state.chatMessages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-message", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `chat-message-role ${msg.role}`, children: msg.role === "user" ? "You" : "BitNet AI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-message-content", children: renderContent(msg.content) })
      ] }, msg.id)),
      state.isStreaming && !state.chatMessages[state.chatMessages.length - 1]?.content && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "typing-indicator", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-input-area", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-input-wrapper", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          ref: textareaRef,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: handleSend,
          disabled: !input.trim() || state.isStreaming || switchingModel,
...
function renderContent(content) {
  ...
  return parts.map((part, i) => {
    if (part.startsWith("```")) {
      ...
      if (match) {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: match[2].trim() }) }, i);
      }
    }
    const inlineParts = part.split(/(`[^`]+`)/g);
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: inlineParts.map((ip, j) => {
      if (ip.startsWith("`") && ip.endsWith("`")) {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: ip.slice(1, -1) }, j);
      }
      return ip;
    }) }, i);
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-bar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `status-dot ${state.aiStatus === "connected" ? "connected" : state.aiStatus === "connecting" ? "loading" : "disconnected"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: state.aiStatus === "connected" ? "AI Connected" : state.aiStatus === "connecting" ? "Connecting..." : "AI Offline" })
      ] }),
      state.projectPath && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: state.projectPath.split(/[/\\]/).pop() }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-right", children: [
      activeFile && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: activeFile.language }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "UTF-8" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "BitNet.cpp" }) })
    ] })
  ] });
}
function SettingsPanel() {
  const { state, dispatch } = useApp();
  const [local, setLocal] = reactExports.useState({ ...state.settings });
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-overlay", onClick: handleCancel, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-panel", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost btn-icon", onClick: handleCancel, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-group-title", children: "Model Configuration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Model Path (.gguf)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary btn-icon", onClick: () => handleBrowse("modelPath"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Server Binary Path (llama-server)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary btn-icon", onClick: () => handleBrowse("serverBinaryPath"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-group-title", children: "Inference" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Context Size" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Max prompt context in tokens (default: 4096)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Threads" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Number of CPU threads (default: 4)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-group-title", children: "Appearance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-field", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: handleCancel, children: "Cancel" }),
...
function CommandPalette() {
  ...
  const commands = [
    {
      id: "open-folder",
      label: "Open Folder",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 14 }),
      shortcut: "",
      action: openFolder
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelLeft, { size: 14 }),
      shortcut: "Ctrl+B",
      action: () => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelRight, { size: 14 }),
      shortcut: "Ctrl+J",
      action: () => {
    ...
    },
    {
      ...
      icon: state.settings.theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 14 }),
      action: () => {
        const newTheme = state.settings.theme === "dark" ? "light" : "dark";
        dispatch({ type: "SET_SETTINGS", settings: { theme: newTheme } });
        window.electronAPI.saveSettings({ theme: newTheme });
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 14 }),
      action: async () => {
    ...
    },
    {
      id: "ai-explain",
      label: "AI: Explain Selection",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { size: 14 }),
    ...
    },
    {
      id: "ai-refactor",
      label: "AI: Refactor Selection",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wand2, { size: 14 }),
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { size: 14 }),
      action: () => dispatch({ type: "TOGGLE_COMMAND_PALETTE" })
    }
  ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "command-palette-overlay", onClick: () => dispatch({ type: "TOGGLE_COMMAND_PALETTE" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "command-palette", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ref: inputRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "command-palette-list", children: [
      filtered.map((cmd, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            cmd.icon,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: cmd.label }),
            cmd.shortcut && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shortcut", children: cmd.shortcut })
          ]
        },
        cmd.id
      )),
      filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "20px", textAlign: "center", color: "var(--text-tertiary)" }, children: "No matching commands" })
    ] })
  ] }) });
}
function DiffPreview() {
  ...
  function handleApply() {
    ...
    dispatch({
      ...
      content: state.diffPreview.modified
    });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "diff-overlay", onClick: handleReject, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "diff-container", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "diff-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Review Changes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "diff-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-secondary", onClick: handleReject, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(XCircle, { size: 14 }),
          "Reject"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary", onClick: handleApply, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 14 }),
          "Apply Changes"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "diff-editor-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      we,
      {
        original: state.diffPreview.original,
        modified: state.diffPreview.modified,
        language: state.openFiles.find((f2) => f2.path === state.diffPreview?.filePath)?.language || "plaintext",
        theme: state.settings.theme === "dark" ? "bitnet-dark" : "bitnet-light",
        options: {
          readOnly: true,
...
function ContextMenu() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: state.contextMenu.items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function TerminalPanel() {
  ...
  const [tabs, setTabs] = reactExports.useState([{ id: "term-1", title: "Terminal 1" }]);
  const [activeTab, setActiveTab] = reactExports.useState("term-1");
  const [isMaximized, setIsMaximized] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (!terminalRef.current || xtermRef.current) return;
    let mounted = true;
    async function initTerminal() {
      const { Terminal: Terminal2 } = await __vitePreload(async () => {
        const { Terminal: Terminal3 } = await import("./xterm-DgC3QH3m.js").then((n2) => n2.x);
        return { Terminal: Terminal3 };
      }, true ? [] : void 0, import.meta.url);
      const { FitAddon } = await __vitePreload(async () => {
        const { FitAddon: FitAddon2 } = await import("./xterm-addon-fit-DWreJD_R.js").then((n2) => n2.x);
      ...
      term.writeln("\x1B[38;2;124;108;240m╭─────────────────────────────────╮\x1B[0m");
      term.writeln("\x1B[38;2;124;108;240m│\x1B[0m  \x1B[1mBitNet IDE Terminal\x1B[0m            \x1B[38;2;124;108;240m│\x1B[0m");
      term.writeln("\x1B[38;2;124;108;240m╰─────────────────────────────────╯\x1B[0m");
      term.writeln("");
      let currentLine = "";
      const cwd = state.projectPath || "C:\\Users";
      term.write(`\x1B[38;2;124;108;240m❯\x1B[0m `);
      term.onKey(({ key, domEvent }) => {
        if (domEvent.key === "Enter") {
          term.writeln("");
          if (currentLine.trim()) {
            processCommand(term, currentLine.trim(), cwd);
          }
          currentLine = "";
          setTimeout(() => {
            term.write(`\x1B[38;2;124;108;240m❯\x1B[0m `);
  ...
  async function processCommand(term, cmd, cwd) {
    ...
    try {
      ...
      if (result.stderr) {
        result.stderr.split("\n").forEach((line) => term.writeln(`\x1B[38;2;232;112;90m${line}\x1B[0m`));
      }
    } catch (err) {
      term.writeln(`\x1B[38;2;232;112;90mError: ${err.message}\x1B[0m`);
    }
  }
  function addTab() {
    const id2 = `term-${Date.now()}`;
    setTabs([...tabs, { id: id2, title: `Terminal ${tabs.length + 1}` }]);
    setActiveTab(id2);
  }
  function closeTab(id2) {
    if (tabs.length <= 1) return;
    const newTabs = tabs.filter((t2) => t2.id !== id2);
    setTabs(newTabs);
    if (activeTab === id2) setActiveTab(newTabs[0].id);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bottom-panel", style: { height: isMaximized ? "60vh" : "200px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bottom-panel-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bottom-panel-tabs", children: [
        tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              tab.title,
              tabs.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 10, onClick: (e) => {
                e.stopPropagation();
                closeTab(tab.id);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost btn-icon", onClick: addTab, title: "New Terminal", style: { width: 24, height: 24 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 12 }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bottom-panel-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-ghost btn-icon", onClick: () => setIsMaximized(!isMaximized), title: isMaximized ? "Restore" : "Maximize", style: { width: 24, height: 24 }, children: isMaximized ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minimize2, { size: 12 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize2, { size: 12 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: "btn btn-ghost btn-icon",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "terminal-content", ref: terminalRef })
  ] });
}
function App() {
  const { state, dispatch } = useApp();
  ...
  async function saveActiveFile() {
    const file = state.openFiles.find((f2) => f2.path === state.activeFilePath);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    ...
    state.screen === "setup" ? /* @__PURE__ */ jsxRuntimeExports.jsx(SetupScreen, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-layout", children: [
      state.sidebarVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "editor-area", children: [
        ...
        state.terminalVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(TerminalPanel, {})
      ] }),
      state.chatPanelVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPanel, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBar, {}),
    state.showSettings && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPanel, {}),
    state.showCommandPalette && /* @__PURE__ */ jsxRuntimeExports.jsx(CommandPalette, {}),
    state.diffPreview && /* @__PURE__ */ jsxRuntimeExports.jsx(DiffPreview, {}),
    state.contextMenu && /* @__PURE__ */ jsxRuntimeExports.jsx(ContextMenu, {})
  ] });
}
