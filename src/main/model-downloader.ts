...
export class ModelDownloader {
    ...
    scanLocalModels(directory: string): Array<{ name: string; filename: string; path: string; size: string }> {
        const models: Array<{ name: string; filename: string; path: string; size: string }> = []
        ...
        try {
            ...
            for (const file of files) {
                if (file.endsWith('.gguf')) {
                    ...
                    // Try to map to a friendly name from our list of available models
